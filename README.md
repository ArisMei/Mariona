...
Toqué algunos botones de la `radio` del barco mientras resolvíamos el misterio del `soplo` nocturo y compartíamos como el barco por la noche había acelerado el paso. 

Salimos del cuarto con las maletas y cerca de un ventanal del barco vimos cómo `atracábamos` en la ciudad de Estocolmo. Era gracioso ya que cada vez que mirábamos a la derecha nuestros compañeros de ventana que descansaban en `sillas acolchadas` cambiaban y venían otros nuevos mientras nosotros nos contentábamos con apoyarnos en la rapisa y no pensábamos mucho en la comodidad.
...
Yo tenía la aplicación descargada y optamos por coger un bus que estaba a algo lejos de la terminal. Desenfundé la aplicación y justo nos dió tiempo a 
